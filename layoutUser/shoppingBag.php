                    ...
                    <form action="" method="POST" class="mt-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="input-group mb-3 quantity-edit">
                                ...
                                <input type="text" class="form-control text-center border-secondary" name="quantity"
                            ...
                            <div class="mb-3"><button type="submit" name="delete" class="btn btn-outline-danger"><i
                                        class="far fa-trash-alt"></i> Delete</button></div>
