...
<div class="container px-5 pb-5 pt-0" style="background-color:#D8DEE5 ;">
    <div class="row">
        <div class="col-4 pt-5">
            <div class="back">
                <a href="../layoutUser" style="background-color:transparent ;"><i
        ...
        <div class="col-4 pt-5">
            <form method="POST">
                <div class="input-group">
                    <input type="text" class="form-control border-secondary border-right-0" name="searchValue"
                        placeholder="Search item.." aria-label="Recipient's username" aria-describedby="button-addon2">
                    <div class="input-group-append">
                        <button class="btn btn-light border-secondary border-left-0" type="submit" name="search"><i
    ...
    <div class="body d-flex flex-wrap justify-content-around">
        ...
        <a href="itemDetails.php?id=<?= $item['id'] ?>" class="card my-4">
            <img class="card-img-top" style="width: 16rem; height: 22rem; object-fit: cover;"
                src="../img/item/item<?= $item['img_status'] == 0 ? 'default' : $item['id'] ?>.jpg" alt="">
            <div class="card-body ">
