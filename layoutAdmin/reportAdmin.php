...
<div class="body">
    ...
    <div class="big-menu w-100">
        <h4 class="active-big-menu">Ringkasan Pembelian</h4>
        <a href="../printPDF.php">
            <button type="submit" class="mb-2 btn btn-success w-100" name="submit">PRINT PDF</button>
        </a>
        <!-- <h4>Akrif</h4>
            <h4>NonAktif</h4> -->
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <?= '<div style="width: 125px" class="rounded text-white text-center ' . ($item_order['delivery_status'] == 'sent' ? 'bg-success">Terkirim</div>' : 'bg-danger">Dibatalkan</div>') ?>
                        </td>
                    </tr>
            <?php
                }
