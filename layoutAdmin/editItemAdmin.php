...
<div class="body">
    ...
    <div class=" form-data">
        ...
        ?>
            <form method="POST" action="../process/editItemAdmin.php">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="stock_s" placeholder="Stock" name="stock_s" value="<?= $data['stock_s']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="stock_m" class="col-sm-2 col-form-label">Stock Size M</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="stock_m" placeholder="Stock" name="stock_m" value="<?= $data['stock_m']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="stock_l" class="col-sm-2 col-form-label">Stock Size L</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="stock_l" placeholder="Stock" name="stock_l" value="<?= $data['stock_l']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="stock_xl" class="col-sm-2 col-form-label">Stock Size XL</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="stock_xl" placeholder="Stock" name="stock_xl" value="<?= $data['stock_xl']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="price" name="price" placeholder="Harga" value="<?= $data['stock_s']; ?>">
                    </div>
                </div>
                <div class="form-group row">
